...
<%@ page import="kz.bitlab.academy.comments.entity.CommentEntity" %>
...
<body>
    ...
    <div class="container">
        ...
        <%
            List<CommentEntity> commentList = (List<CommentEntity>) request.getAttribute("commentList");
            for(CommentEntity comment: commentList){
        %>
        <div class="container mt-3 border border-info">
            <h1>POST DATE: <b><%=comment.getPost_date()%></b></h1>
            <p>COMMENT: <%=comment.getComment()%></p>
            <h3>Author: <%=comment.getUser().getFullName()%></h3>
        </div>
